...
const ProjectsSection = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'A modern, responsive portfolio website with 3D elements, smooth animations, and optimized performance.',
      image: '/placeholder.svg',
      technologies: ['React', 'Three.js', 'Framer Motion', 'Tailwind CSS', 'Vercel'],
      liveUrl: '#',
      githubUrl: '#',
      featured: false
    }
