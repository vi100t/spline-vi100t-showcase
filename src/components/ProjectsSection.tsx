  ...
  const projects = [
    {
      ...
      description: 'A beautiful website for Casa Amarela Piauí, showcasing local culture, tourism, and heritage. Built with modern web technologies and responsive design.',
    ...
    },
    {
      ...
      image: '/placeholder.svg',
      technologies: ['React', 'TypeScript', 'Chart.js', 'Weather API', 'Styled Components'],
      liveUrl: '#',
      githubUrl: 'https://github.com/vi100t',
      featured: false
    }
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-12 mb-16">
            {featuredProjects.map((project, index) => (
              <Card key={index} className="overflow-hidden hover:shadow-xl transition-all duration-300 border-accent/20">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {otherProjects.map((project, index) => (
                <Card key={index} className="overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-accent/20">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.technologies.slice(0, 3).map((tech, techIndex) => (
                        <Badge key={techIndex} variant="secondary" className="text-xs bg-accent/10 text-accent">
                          {tech}
                        </Badge>
                      ))}
                    ...
                    <div className="flex gap-3">
                      <Button size="sm" asChild className="bg-accent hover:bg-accent/90 text-primary">
                        <a href={project.liveUrl} target="_blank" rel="noopener noreferrer">
                          <ExternalLink className="w-3 h-3 mr-2" />
                          Demo
                        </a>
                      </Button>
                      <Button size="sm" variant="outline" asChild className="border-accent text-accent hover:bg-accent hover:text-primary">
                        <a href={project.githubUrl} target="_blank" rel="noopener noreferrer">
